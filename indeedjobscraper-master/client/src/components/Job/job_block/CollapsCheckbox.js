...
import faAngleDown from '@fortawesome/fontawesome-free-solid/faAngleDown';  // 向下箭头
import faAngleUp from '@fortawesome/fontawesome-free-solid/faAngleUp';  // 向上箭头
